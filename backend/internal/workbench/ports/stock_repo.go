...
type StockRepository interface {
	...
	// SyncStockBasic 全量同步 A 股基础信息到 stock_info
	SyncStockBasic(source string) (*stock.StockBasicSyncResult, error)
	// GetStockBasicSyncStatus 查询 stock_info 同步状态
	GetStockBasicSyncStatus(dataPath string) (*stock.StockBasicSyncStatus, error)
}
