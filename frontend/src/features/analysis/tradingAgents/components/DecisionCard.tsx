import { TrendingUp, TrendingDown, Target, Shield, Info } from 'lucide-react'
        ...
        <div className="card overflow-hidden">
            ...
            {reasoning && (
                <div className="mb-4 rounded-lg bg-slate-50 p-3 dark:bg-slate-800/50">
                    ...
                    <div className="prose prose-sm dark:prose-invert mt-1 max-w-none text-slate-700 dark:text-slate-300">
